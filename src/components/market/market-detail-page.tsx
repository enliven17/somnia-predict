                        ...
                        if (hasWinningShares) {
                          return (
                            <Button
                              ...
                              className="w-full bg-gradient-to-r from-[#9b87f5] to-[#7c3aed] hover:from-[#7c3aed] hover:to-[#6d28d9] text-white shadow-lg"
                              size="sm"
                            >
                              💰 Claim Winnings
                            </Button>
                      ...
                      <div className="space-y-3 pt-4 border-t border-gray-800/50">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Button
                            ...
                            className="bg-gradient-to-r from-[#9b87f5] to-[#7c3aed] hover:from-[#7c3aed] hover:to-[#6d28d9] text-white text-xs"
                            size="sm"
                          >
                            {market.optionA} Wins
                          </Button>
